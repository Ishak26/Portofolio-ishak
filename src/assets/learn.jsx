...
function ListEducation({educationName,yearStar,yearEnd}){
  return (
    <>
      <li className="p-5 " >
          <p className="font-semibold" >{educationName} ({yearStar} - {yearEnd})</p>
  ...
  return <div>
    <section className="mt-14 max-w-screen-md min-h-screen m-auto"> 
      ...
      <div className="flex flex-column mb-[-2px]">
        ...
        className="px-5 font-mono bg-bluelight border-2 border-black border-b-0 z-20 rounded-tl-xl">Formal</button>
        <button
        onClick={()=>{
          setEducation("Non-Formal")
        }}
        className="p-3 font-mono bg-neonpink border-2 border-black border-b-0 z-20 rounded-tr-xl">Non-Formal</button>
      </div>
